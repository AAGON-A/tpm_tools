...
Start with the ADRs (`05-api-architecture-adrs/adrs/`) if you want to see technical judgment and writing. Start with `01-program-health-dashboard/sample_output/weekly_status_report.md` if you want to see the data side.
